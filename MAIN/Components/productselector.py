...
class ProductSelector(tk.Frame):
    def __init__(self, parent, root_frame, row, func):
        ...
        self.menuBtn = ttk.Menubutton(root_frame, text="Выберите блюдо")

        self.menu = tk.Menu(self.menuBtn, tearoff=0)
        self.m_var1 = tk.StringVar()
        self.m_var1.set("Выберите блюдо")
        ...
        self.order_st_lb = ttk.Label(root_frame,  text="В обработке")
    ...
    def order_updt(self):
        self.order_st_lb.config(text="Заказан")
